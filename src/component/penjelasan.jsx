...
const PLACEHOLDER = "https://via.placeholder.com/800x480.png?text=No+Image";
...
function WhenSection({ title, text }) {
  ...
  return (
    <div className="mt-10">
      <h3 className="text-2xl md:text-3xl font-playfair font-semibold text-[#1E3A3A] mb-4 text-center md:text-left">
        {title}
      </h3>
      <p className="text-[#233] leading-7 font-poppins text-center md:text-left">
...
function Penjelasan({ province, items = [] }) {
  ...
  return (
    <div id="penjelasan" className="max-w-7xl mx-auto py-16 px-4">
      {filtered.length === 0 && (
        <p className="text-center text-[#335]">
          Belum ada data untuk provinsi ini.
        </p>
      )}
